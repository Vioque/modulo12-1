...
// These are the percent-encoded utf-8 octets representing a checkmark, indicating that the request actually is utf-8 encoded.
  ...
  'pages/movements/movements.mappers.js': [function(require, module, exports) {
    ...
    var mapMovementsListFromApiToViewModel = function mapMovementsListFromApiToViewModel(movementsList) {
      return movementsList.map(function(account) {
        return mapMovementsFromApiToViewModel(account);
      });
    };
    exports.mapMovementsListFromApiToViewModel = mapMovementsListFromApiToViewModel;
    var mapMovementsFromApiToViewModel = function mapMovementsFromApiToViewModel(account) {
      return {
        id: account.id,
        iban: account.iban,
        name: account.name,
  ...
  'common/helpers/element.helpers.js': [function(require, module, exports) {
    ...
    function _iterableToArrayLimit(arr, i) {
      ...
      if (null != _i) {
        ...
        } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i.return && (_r = _i.return(), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } }
        return _arr;
      }
    }
  ...
  'pages/movements/movements.js': [function(require, module, exports) {
    ...
    (0, _movements.getMovements)(params.id).then(function(movementsList) {
      var viewModelMovements = (0, _movements3.mapMovementsListFromApiToViewModel)(movementsList);
      (0, _movements2.addMovementRows)(viewModelMovements);
      console.log({
        movementsList: movementsList,
      });
      viewModelMovements.forEach(function(movementsList) {
        (0, _helpers.onSetValues)('select-'.concat(movementsList.accountId), function(event) {
    ...
    './movements.api': 'pages/movements/movements.api.js',
    '../../core/router': 'core/router/index.js',
    './movements.helpers': 'pages/movements/movements.helpers.js',
    './movements.mappers': 'pages/movements/movements.mappers.js',
